...
here::i_am("FINAL_PROJECT_Amaka.Rmd")
file_path <- here("raw data", "Georgia_DPH_PUBLIC_Vaccination_Public_Data_in_Excel-2.xlsx")


df <- read_excel(file_path, sheet = "COUNTY_SUMMARY")
...
p <- ggplot(df, aes(x = reorder(COUNTY_NAME, -PERSONCVAX), y = PERSONCVAX)) +
